...
// 카테고리 파라메타 받기
String categoryNo = request.getParameter("p_category_no");

// 파라메타 체크
if (categoryNo == null || categoryNo.equals("")) {
	response.sendRedirect("product_category_list.jsp");
	//productList= productService.findBestList();
...
//타입변환
int a = Integer.parseInt(categoryNo);
if (a == 2100 || a == 2200) { 
	/* 받은 번호가 의류카테고리*/
	productList = productService.findByCategorySize(a);
} else {   
	/*다른 카테고리*/ 
	productList = productService.findByCategory(a);
}
}
